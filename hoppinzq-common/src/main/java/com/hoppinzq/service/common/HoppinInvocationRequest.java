...
/**
 * @author:ZhangQi 请求是服务调用方的MethodInvocationHandler方法封装发出的，
 * 注册中心跟服务调用方约定的通信协议是在http正文下封装了一段标准的java代码二进制序列化，暂时就叫zq协议>_<
 */
public class HoppinInvocationRequest implements Serializable {

    private static final ThreadLocal<Serializable> requestHolder = new ThreadLocal<Serializable>();
    /**
     * 服务名（必选）
     */
     ...
     * @param credentials
     */
    public HoppinInvocationRequest(Method method, Object[] parameters, Serializable credentials) {
    ...
    public HoppinInvocationRequest() {
    }
