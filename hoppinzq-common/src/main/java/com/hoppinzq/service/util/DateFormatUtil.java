...
public class DateFormatUtil {
    ...
    public static String stampToDateDay(String s) {
        ...
        return stampToDateDay(lt);
    }

    public static String stampToDateDayNow() {
        return stampToDateDay(System.currentTimeMillis());
    }

    /*
     * 将时间戳转换为时间
     */
    public static String stampToDateDay(Long lt) {
        String res;
