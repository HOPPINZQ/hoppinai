...
public class ServiceMethodApiBean {
    ...
    public ServiceMethodAnnotationMapping serviceMethodAnnotationMapping;//注解
    ...
    public ServiceMethodAnnotationMapping getServiceMethodAnnotationMapping() {
        return serviceMethodAnnotationMapping;
    }

    public void setServiceMethodAnnotationMapping(ServiceMethodAnnotationMapping serviceMethodAnnotationMapping) {
        this.serviceMethodAnnotationMapping = serviceMethodAnnotationMapping;
    }
