...
import com.hoppinzq.api.dto.FileBean;
import com.hoppinzq.base.service.BaseFileService;
import com.hoppinzq.constants.ProjectParm;
import com.hoppinzq.util.EncryptUtil;
import com.hoppinzq.util.UUIDUtil;
...
public class BaseFileController {
    ...
    public JSONObject blogFileUploadFj(MultipartFile file) {
        ...
        try {
            ...
            String last_videoName__ = ProjectParm.resourcesPath + last_fileName;
    ...
    public JSONObject base(MultipartFile img) {
        ...
        try {
            ...
            String fileID = UUIDUtil.getUUID();
            String last_fileName = fileID + fileType;
            String last_fileName__ = ProjectParm.resourcesPath + last_fileName;
