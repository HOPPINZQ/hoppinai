...
![OpenAI](https://img.shields.io/badge/大模型-Claude-green?style=flat&logo=Claude&logoColor=white)
...
> - 目前编程领域排名第一的大模型是‌Claude Sonnet 4  
> 
> 不过Claude禁止国内使用了，我们有替代的国产大模型：智谱GLM-4.6‌，
> 其代码能力已对齐Claude Sonnet 4。  
> 因此我们需要使用智谱API，智谱API提供了Claude API的兼容，自然就支持anthropic JavaSDK对大模型的调用，因为都是OpenAI协议。  
> 这，就是协议
> 
...
我的感受是非常nice，我只需要告诉AI我们要实现什么功能（我一般是生成xxx页面），
智能体就会自动帮我创建前端工程，编写前端代码，预览前端页面。
