...
import com.hoppinzq.red95.model.Red95Error;
import com.hoppinzq.red95.model.Red95HttpException;
...
public class ResponseBodyCallback implements Callback<ResponseBody> {
    private static final ObjectMapper mapper = Red95Service.defaultObjectMapper();
        ...
        try {
            if (!response.isSuccessful()) {
                ...
                if (errorBody == null) {
                    ...
                    Red95Error error = mapper.readValue(
                            errorBody.string(),
                            Red95Error.class
                    );
