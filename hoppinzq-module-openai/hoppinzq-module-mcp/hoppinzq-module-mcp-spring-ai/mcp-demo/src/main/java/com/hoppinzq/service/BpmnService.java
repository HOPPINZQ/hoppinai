...
/**
 * 如果需要我演示用的工作流的开源项目，请微信：zhangqiff19
 */
@Service
public class BpmnService {
    ...
    @Tool(name = "get_assign_user_phone_and_email", description = "获取审批人的手机号和邮箱")
    public String get_assign_user_phone_and_email(@ToolParam(description = "审批人") String assignUser) {
        // 这里我直接写死了
        if ("admin".equalsIgnoreCase(assignUser)) {
            JSONObject jsonObject = new JSONObject();
            jsonObject.put("phone", "150xxxx2175");
            jsonObject.put("email", "anmiezata@163.com");
