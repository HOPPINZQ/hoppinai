...
/**
 * @author:ZhangQi 代理每个调用参数对象来跟踪对对象的更改
 * 以及跟踪在服务执行时调用的setter的更改。
 */
@InterfaceImplName("跟踪setter方法")
public class SetterModificationManager implements ModificationManager, Serializable {
     ...
     * 创建setter方法代理
     *
     * @param currentDepth     递归深度
     * @param object           代理对象
     * @param parentPath       父级路径，在递归过程中用于拼接属性路径。
     * @param modificationList 修改列表，用于记录属性的修改操作。
     * @return
     */
